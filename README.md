...
This is a lightly customised fork of the excellent [ph00lt0/blocklist](https://github.com/ph00lt0/blocklist).
...
All credit goes to [ph00lt0](https://github.com/ph00lt0) for building and maintaining the original list. If you find this useful, please consider [donating to the original author](https://github.com/ph00lt0/blocklist?tab=readme-ov-file#donations) — they deserve it.
...
```
mkdir /media/littlesnitch-blocklist/
echo "wget -O https://raw.githubusercontent.com/CaptainCodeAU/littlesnitch_blocklist/master/blocklist.txt -O /media/littlesnitch-blocklist/blocklist.txt" > updater.sh
chmod +x ./updater.sh
crontab -l | { cat; echo "00 11 * * * /media/littlesnitch-blocklist/updater.sh"; } | crontab -
./updater.sh
```
...
Feel free to report a broken website under [Github issues](https://github.com/CaptainCodeAU/littlesnitch_blocklist/issues/new?&template=broken-website-or-app.md). We will not remove any website because it has 'ethical' tracking, ads or whatsoever.

## Can you make a list available for tool 'x'?

Feel free to [open an issue](https://github.com/CaptainCodeAU/littlesnitch_blocklist/issues/new) with the request.
